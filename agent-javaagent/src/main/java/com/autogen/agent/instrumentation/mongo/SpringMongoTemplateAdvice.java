...
public class SpringMongoTemplateAdvice {
    @Advice.OnMethodEnter(suppress = Throwable.class)
    public static long enter() {
        TraceContext.currentOrCreate("spring-data-mongo");
    ...
    public static void exit(@Advice.Enter long startedAt,
        ...
        metadata.put("client", "Spring MongoTemplate");
        ...
        if (GlobalRecorder.get().config().getMongo().isCapturePayloads()) {
